...
public class AppNotUsingLatestVersion
{

    private static final Logger LOGGER = LoggerFactory.getLogger(AppNotUsingLatestVersion.class);
    private static final String topic = "offer";
    public static void main( String[] args ) {

        Properties props = new Properties();
        props.put("bootstrap.servers", "localhost:9092");
        props.put("group.id", "group1-not-using-latest");
