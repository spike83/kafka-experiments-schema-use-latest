...
public class AppNotUsingLatestVersionGenericRecord
{

    private static final Logger LOGGER = LoggerFactory.getLogger(AppNotUsingLatestVersionGenericRecord.class);
    private static final String topic = "offer";
    public static void main( String[] args ) {

        Properties props = new Properties();
        props.put("bootstrap.servers", "localhost:9092");
        props.put("group.id", "group1-not-using-latest-generic");
