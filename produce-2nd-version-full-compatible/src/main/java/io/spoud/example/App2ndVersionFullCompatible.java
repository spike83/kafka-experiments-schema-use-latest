...
public class App2ndVersionFullCompatible
{

    private static final Logger LOGGER = LoggerFactory.getLogger(App2ndVersionFullCompatible.class);
    ...
    private static ProducerRecord<String,io.spoud.example.Offer> createRandomRecord() {
        return new ProducerRecord<>(topic, UUID.randomUUID().toString(), io.spoud.example.Offer.newBuilder()
                ...
                .setContent("content " + UUID.randomUUID())
                .setForceUpdate(true)
                .build());
    }
}
